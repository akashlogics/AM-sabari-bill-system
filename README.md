# AM Sabari VEGETABLES — பில்லிங் & கணக்கு (Supabase + Render)
...
2. **Authentication** → **Users** → **Add user** → **Create new user**.
   - Email: `user@gmail.com` (அல்லது `public/config.js`-ல் உள்ள `loginEmail`-உடன் **சரியாக பொருந்த வேண்டும்**).
   - Password: **இதுவே கடை PIN** — உதாரணமாக `2580` அல்லது `AmSabari2026` — அவர் எதை
...
const SUPABASE_CONFIG = {
  ...
  loginEmail: 'sabribills123@gmail.com'       // படி 2-ல் உருவாக்கிய அதே email
};
```

> ⚠️ **`service_role` key-ಐ ஒருபோதும் இங்கு பயன்படுத்த வேண்டாம்** — அது
...
3. அமைப்புகள்:
   ...
   - **Environment**: Node
4. Deploy ஆனதும், Render ஒரு URL தரும் (எ.கா. `https://am-sabari-vegetables.onrender.com`) —
...
### பொருட்கள் / வாடிக்கையாளர் தேடல் (Search) — 62+ வாடிக்கையாளர், 35+ பொருட்கள்
"பொருட்கள்" மற்றும் "வாடிக்கையாளர்" தாவல்களில் பட்டியலுக்கு மேலே ஒரு 🔍 தேடல்
பெட்டி சேர்க்கப்பட்டுள்ளது. தட்டச்சு செய்ததும் உடனே பட்டியல் வடிகட்டப்படும்
(எதுவும் சேமிக்க தேவையில்லை) — இது ஒரு புதிய பொருள்/வாடிக்கையாளரை சேர்க்கும்
முன், அது ஏற்கனவே பட்டியலில் இருக்கிறதா என விரைவாக சரிபார்க்க உதவும்,
குறிப்பாக மொபைலில் scroll செய்யாமல். வாடிக்கையாளர் தேடலில் பெயருடன் WhatsApp
எண்ணையும் தேடலாம்.

### எல்லா பதிவிறக்கமும் இப்போது உண்மையான Excel (.xlsx) — CSV இல்லை
"நாள் கணக்கு" மட்டுமல்ல — **அறிக்கை (Reports)** மற்றும் **மாத சுருக்கம்**
பதிவிறக்கங்களும் இப்போது `.xlsx`. மூன்றுமே SheetJS மூலம் client-side-லேயே
உருவாக்கப்படுகின்றன, Tamil எழுத்துக்கள் சரியாக காட்டப்படும், தொகைகள் text
அல்ல real numbers-ஆக இருக்கும் (Excel-ல் select செய்து sum பார்த்து
சரிபார்க்கலாம்).

### பணம் பெற்றவர்கள் பட்டியல் + தவறான பணம் பதிவை நீக்குதல்
**நாள் கணக்கு (Daily Ledger)** தாவலில், முதன்மை அட்டவணைக்கு கீழே ஒரு புதிய
"💰 பணம் பெற்றவர்கள்" பட்டியல் சேர்க்கப்பட்டுள்ளது — தேர்ந்தெடுத்த தேதிக்கு
பதிவான **ஒவ்வொரு பணம் பெற்ற பதிவும்** தனித்தனியாக (ஒரு வாடிக்கையாளர் அன்று
இரண்டு முறை பணம் கொடுத்திருந்தாலும் இரண்டு வரிசைகளாக) காட்டப்படும் — பெயர்,
தொகை, குறிப்பு, நேரம். ஒவ்வொரு வரிசைக்கும் ஒரு 🗑 நீக்கு பொத்தான் — தவறாக
பதிவு செய்த பணத்தை உடனே நீக்கலாம், பாக்கி தொகை தானாக சரியாகும்.

### பில் Format மாற்றம் — "வரவு" & "பாக்கித் தொகை" சேர்க்கப்பட்டது
நீங்கள் அனுப்பிய screenshot-ஐ பின்பற்றி, பில் இப்போது இந்த வரிசையில் காட்டும்:

```
இன்றைய தொகை   (சிவப்பு, bold) — இந்த பில்லின் பொருட்கள் மொத்தம்
முன் பாக்கி
─────────────
மொத்தம்         — (இன்றைய தொகை + முன் பாக்கி)
வரவு           (சிவப்பு) — இதே தேதியில் ஏற்கனவே பெற்ற பணம் (ஏதேனும் இருந்தால்)
─────────────
பாக்கித் தொகை   (பெரிய, bold) — (மொத்தம் − வரவு)
```

**"வரவு" எப்படி வேலை செய்யும்**: பில் போடும் நேரத்தில், அதே நாளில் அந்த
வாடிக்கையாளருக்கு ஏற்கனவே ஏதேனும் "பணம் பெற்றது" பதிவு செய்திருந்தால், அது
இந்த பில்லில் "வரவு"-ஆக காட்டப்படும் — அச்சிட்ட காகித பில் போலவே, அந்த
நேரத்தில் இருந்த நிலையை (snapshot) பில்லில் நிரந்தரமாக பதிவு செய்கிறது.
பில் போட்ட **பிறகு** பணம் வாங்கினால், அது அந்த பில்லில் சேராது (ஏற்கனவே
கொடுத்த/பகிர்ந்த பில் மாறாது) — ஆனால் "நாள் கணக்கு" / "பணம் பெற்றவர்கள்"
பட்டியலில் சரியாகவே தெரியும்.

⚠️ **இதற்கு Supabase-ல் ஒரு column சேர்க்க வேண்டும்** — `supabase/schema.sql`
கோப்பில் `paid_on_bill_date` column புதிதாக சேர்க்கப்பட்டுள்ளது. ஏற்கனவே
live-ல் இருக்கும் உங்கள் database-க்கு, SQL Editor-ல் இந்த ஒரு வரியை மட்டும்
ரன் செய்தால் போதும் (முழு schema.sql-ஐயும் மீண்டும் ரன் செய்யலாம், பாதுகாப்பானது):

```sql
alter table bills add column if not exists paid_on_bill_date numeric not null default 0;
```

இதை ரன் செய்யாமல் `public/` கோப்புகளை மட்டும் deploy செய்தால், புதிய பில்
போடும்போது "column paid_on_bill_date does not exist" என பிழை வரும் — எனவே
இந்த ஒரு SQL வரியை முதலில் ரன் செய்யவும், அப்புறம் `public/` கோப்புகளை
redeploy செய்யவும்.

### புதிய பில் (New Bill) — வாடிக்கையாளர் & பொருள் தேடல்
"புதிய பில்" தாவலில் இப்போது இரண்டு இடங்களிலும் dropdown-க்கு பதிலாக
தேடல் பெட்டி:
- மேலே **வாடிக்கையாளர் தேர்வு** — பெயர் அல்லது WhatsApp எண் தட்டச்சு
  செய்தவுடன் பொருந்தும் வாடிக்கையாளர்கள் மட்டும் தெரியும்.
- ஒவ்வொரு பில் வரிசையிலும் **பொருள்** column — பொருளின் பெயரை தட்டச்சு
  செய்தால் பொருந்தும் பொருட்கள் மட்டும் (விலை/அலகுடன்) தெரியும்.

இரண்டும் ஒரு பட்டியலில் இருந்து தட்டி தேர்வு செய்யும் வரை பழைய dropdown
போலவே செயல்படும் — உள்ளூர் தரவு மாதிரி (`billCustomerSelect` / row-க்கான
`.row-item-select`) மாறவில்லை, வெறும் தேர்வு செய்யும் விதம் மட்டும் மாறியது.

**Developer note**: dropdown பட்டியல் (`.combo-list`) `<body>`-க்கு நேரடியாக
நகர்த்தப்பட்டு `position: fixed` மூலம் காட்டப்படுகிறது — இல்லையெனில் பில்
அட்டவணையின் horizontal-scroll wrapper அதை மேலிருந்து clip செய்துவிடும்.
வரிசை நீக்கும்போது (`row-del-btn`) அந்த orphaned dropdown node-ஐயும்
நீக்குகிறோம் (`itemComboListEl.remove()`), இல்லையெனில் அது `<body>`-ல்
மறைந்தே தங்கிவிடும்.
...
இந்த Supabase project-ஐ Am.Sabari. VEGETABLES-க்கு மட்டும் என தனி Organization/
